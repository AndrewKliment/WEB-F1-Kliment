...
export const teams = [
  {
    ...
    cardCar: `${URL}teams/ferrari-car.png`,
    heroLogo: `${URL}teams-logo/ferrari-logo.png`,
    heroCar: `${URL}teams/ferrari-car.png`,
    drivers: [
      { id: "leclerc", name: "CHARLES \n\n LECLERC", img: `${URL}driver-portrait/charles.leclerc.png` },
      { id: "hamilton", name: "LEWIS \n\n HAMILTON", img: `${URL}driver-portrait/lewis.hamilton.png` }
    ],
    profile: {
    ...
    photos: [`${URL}teams-bio/ferrari-h-v-l.png`, `${URL}teams-bio/ferrari-car-team.jpg`]
  },
  {
    id: "redbull",
    ...
    cardCar: `${URL}teams/redbull-car.png`,
    heroLogo: `${URL}teams-logo/redbull.png`,
    heroCar: `${URL}teams/redbull-car.png`,
    drivers: [
      { id: "verstappen", name: "MAX \n\nVERSTAPPEN", img: `${URL}driver-portrait/max.verstappen.png` },
      { id: "tsunoda", name: "YUKI \n\n TSUNODA", img: `${URL}driver-portrait/tsunoda.png` }
    ],
    profile: {
    ...
    photos: [`${URL}teams-bio/redbull-team.jpg`, `${URL}teams-bio/redbull-100th.jpg`]
  },
  {
    id: "mclaren",
    ...
    cardCar: `${URL}teams/mclaren-car.png`,
    heroLogo: `${URL}teams-logo/mclaren.png`,
    heroCar: `${URL}teams/mclaren-car.png`,
    drivers: [
      { id: "norris", name: "LANDO NORRIS", img: `${URL}driver-portrait/lando.norris.png` },
      { id: "piastri", name: "OSCAR PIASTRI", img: `${URL}driver-portrait/oscar.piastri.png` }
    ],
    profile: {
    ...
    photos: [`${URL}teams-bio/mclaren-team.jpg`, `${URL}teams-bio/mclaren-pit.jpg`]
  },
  {
    id: "mercedes",
    ...
    cardCar: `${URL}teams/mercedes-car.png`,
    heroLogo: `${URL}teams-logo/mercedes.png`,
    heroCar: `${URL}teams/mercedes-car.png`,
    drivers: [
      { id: "antonelli", name: "KIMI ANTONELLI", img: `${URL}driver-portrait/kimi.antonelli.png` },
      { id: "russell", name: "GEORGE RUSSELL", img: `${URL}driver-portrait/george.russell.png` }
    ],
    profile: {
    ...
    photos: [`${URL}teams-bio/mercedes-trio.jpg`, `${URL}teams-bio/mercedes-pit.jpg`]
  },
  {
    id: "aston",
    ...
    cardCar: `${URL}teams/astonmartin-car.png`,
    heroLogo: `${URL}teams-logo/astonmartin.png`,
    heroCar: `${URL}teams/astonmartin-car.png`,
    drivers: [
      { id: "alonso", name: "FERNANDO ALONSO", img: `${URL}driver-portrait/fernando.alonso.png` },
      { id: "stroll", name: "LANCE STROLL", img: `${URL}driver-portrait/lance.stroll.png` }
    ],
    profile: {
    ...
    photos: [`${URL}teams-bio/astonmartin-duo.jpg`, `${URL}teams-bio/astonmartin-pit.jpg`]
  },
  {
    id: "williams",
    ...
    cardCar: `${URL}teams/williams-car.png`,
    heroLogo: `${URL}teams-logo/williams.png`,
    heroCar: `${URL}teams/williams-car.png`,
    drivers: [
      { id: "albon", name: "ALEX \n\n ALBON", img: `${URL}driver-portrait/alex.albon.png` },
      { id: "sainz", name: "CARLOS SAINZ", img: `${URL}driver-portrait/carlos.sainz.png` }
    ],
    profile: {
    ...
    photos: [`${URL}teams-bio/williams-duo.jpg`, `${URL}teams-bio/williams-baku.jpg`]
  },
  {
    id: "kick",
    ...
    cardCar: `${URL}teams/kicksauber-car.png`,
    heroLogo: `${URL}teams-logo/kick.png`,
    heroCar: `${URL}teams/kicksauber-car.png`,
    drivers: [
      { id: "hulkenberg", name: "NICO HÜLKENBERG", img: `${URL}driver-portrait/nico.hulkenberg.png` },
      { id: "bortoleto", name: "GABRIEL BORTOLETO", img: `${URL}driver-portrait/gabriel.bortoleto.png` }
    ],
    profile: {
    ...
    photos: [`${URL}teams-bio/kick-uk.jpg`, `${URL}teams-bio/kick-photo.jpg`]
  },
  {
    id: "alpine",
    ...
    cardCar: `${URL}teams/alpine-car.png`,
    heroLogo: `${URL}teams-logo/alpine.png`,
    heroCar: `${URL}teams/alpine-car.png`,
    drivers: [
      { id: "gasly", name: "PIERRE GASLY", img: `${URL}driver-portrait/pierre.gasly.png` },
      { id: "colapinto", name: "FRANCO COLAPINTO", img: `${URL}driver-portrait/franco.colapinto.png` }
    ],
    profile: {
    ...
    photos: [`${URL}teams-bio/alpine-gasly.jpg`, `${URL}teams-bio/alpine-photo.jpg`]
  },
  {
    id: "visarb",
    ...
    cardCar: `${URL}teams/rb-car.png`,
    heroLogo: `${URL}teams-logo/vcarb.png`,
    heroCar: `${URL}teams/rb-car.png`,
    drivers: [
      { id: "lawson", name: "LIAM LAWSON", img: `${URL}driver-portrait/liam.lawson.png` },
      { id: "hadjar", name: "ISACK HADJAR", img: `${URL}driver-portrait/isack.hadjar.png` }
    ],
    profile: {
    ...
    photos: [`${URL}teams-bio/vcarb-podium.jpg`, `${URL}teams-bio/vcarb-pit.jpg`]
  },
  {
    id: "haas",
    ...
    cardCar: `${URL}teams/haas-car.png`,
    heroLogo: `${URL}teams-logo/haas.png`,
    heroCar: `${URL}teams/haas-car.png`,
    drivers: [
      { id: "ocon", name: "ESTEBAN OCON", img: `${URL}driver-portrait/esteban.ocon.png` },
      { id: "bearman", name: "OLLIE BEARMAN", img: `${URL}driver-portrait/ollie.bearman.png` }
    ],
    profile: {
    ...
    photos: [`${URL}teams-bio/haas-ocon.jpg`, `${URL}teams-bio/haas-photo.jpg`]
  }
];